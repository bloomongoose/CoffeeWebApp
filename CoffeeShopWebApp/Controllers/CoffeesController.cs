...
namespace CoffeeShopWebApp.Controllers
{
    public class CoffeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Item,Description,Price")] Coffee coffee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Item,Description,Price")] Coffee coffee)
        {
            if (id != coffee.Id)
            {
                return NotFound();
